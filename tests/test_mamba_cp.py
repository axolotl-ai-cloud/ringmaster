...
A reference global SSD recurrence vs. the CP scheme (local zero-init scan +
ring_shift_ssm_state + mamba2_cp_correction) must match. Exact for the single-hop
shift on 2 ranks (rank 1's entering state == rank 0's final state).
"""
